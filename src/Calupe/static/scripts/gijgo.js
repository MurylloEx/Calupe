...
gj.widget = function() {
        ...
        parseDate: function(a, b, c) {
            ...
            if (a && "string" == typeof a) {
                if (/^\d+$/.test(a)) g = new Date(a);
                    ...
                    for (f = b.split(/[\s,-\.\/\/\:]+/), e = a.split(/[\s]+/), e.length != f.length && (e = a.split(/[\s,-\.\/\/\:]+/)), d = 0; d < f.length; d++)["d", "dd"].indexOf(f[d]) > -1 ? j = parseInt(e[d], 10) : ["m", "mm"].indexOf(f[d]) > -1 ? i = parseInt(e[d], 10) - 1 : "mmm" === f[d] ? i = gj.core.messages[c || "pt-br"].monthShortNames.indexOf(e[d]) : "mmmm" === f[d] ? i = gj.core.messages[c || "pt-br"].monthNames.indexOf(e[d]) : ["yy", "yyyy"].indexOf(f[d]) > -1 ? (h = parseInt(e[d], 10), "yy" === f[d] && (h += 2e3)) : ["h", "hh", "H", "HH"].indexOf(f[d]) > -1 ? k = parseInt(e[d], 10) : ["M", "MM"].indexOf(f[d]) > -1 && (l = parseInt(e[d], 10));
        ...
        formatDate: function(a, b, c) {
            ...
            for (h = h.splice(1, h.length - 2), i = 0; i < g.length; i++) switch (d = h[i] || "", g[i]) {
                ...
                case "dd":
                    ...
                    break;
                case "ddd":
                    f += gj.core.messages[c || "pt-br"].weekDaysShort[a.getDay()] + d;
                    break;
                case "dddd":
                    f += gj.core.messages[c || "pt-br"].weekDays[a.getDay()] + d;
                    break;
                case "m":
                    f += a.getMonth() + 1 + d;
                    break;
                case "mm":
                    ...
                    break;
                case "mmm":
                    f += gj.core.messages[c || "pt-br"].monthShortNames[a.getMonth()] + d;
                    break;
                case "mmmm":
                    f += gj.core.messages[c || "pt-br"].monthNames[a.getMonth()] + d;
                    break;
                case "yy":
    ...
    }(jQuery), gj.dialog.messages["pt-br"] = {
        Close: "Close",
        DefaultTitle: "Dialog"
    }, gj.draggable = {
        plugins: {}
    ...
    function(a) {
        ...
        Refresh: "Recarregar",
        Of: "de",
        DisplayingRecords: "Exibindo registros",
    ...
    }(jQuery), gj.editor.messages["pt-br"] = {
        bold: "Bold",
        italic: "Italic",
